...
<body>
	...
	<div class="container">
		...
		<!-- Add a search form -->
		<form action="/sprinig_mvc_studentDetails/studentdetails/search" class="form-inline">

			<!-- Add a button -->
			<a href="/sprinig_mvc_studentDetails/studentdetails/showFormForAdd"
